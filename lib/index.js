...
function Faker (opts) {
  ...
  var ElectronicDevices = require('./electronicDevices');
  self.electronicDevices = new ElectronicDevices(self);
  ...
  var _definitions = {
    ...
    "electronicDevices": ["electronicDevices", "brand", "model", "type", "color"],
